...
A _$AFromJson(Map<String, dynamic> json) => A(id: json['id'] as String);
...
) => B<T>(id: json['id'] as String, blah: fromJsonT(json['blah']));

Map<String, dynamic> _$BToJson<T>(
  B<T> instance,
  Object? Function(T value) toJsonT,
) => <String, dynamic>{'id': instance.id, 'blah': toJsonT(instance.blah)};

X _$XFromJson(Map<String, dynamic> json) => X(xyz: json['xyz'] as String);
