...
Pet _$PetFromJson(Map<String, dynamic> json) =>
    Pet(name: json['name'] as String, age: (json['age'] as num).toInt());
...
X _$XFromJson(Map<String, dynamic> json) => X(val: json['val'] as String);

Map<String, dynamic> _$XToJson(X instance) => <String, dynamic>{
  'val': instance.val,
};

Y _$YFromJson(Map<String, dynamic> json) =>
    Y(val: json['val'] as String, valY: (json['valY'] as num).toInt());
